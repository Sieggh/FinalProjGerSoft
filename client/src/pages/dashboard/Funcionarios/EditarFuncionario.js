...
const EditarFuncionario = () => {
  ...
  if (nomeEmpresa) {
    ...
    try {
        ...
        setFormData(dados);
        setDadosOriginais(dados); // salva para restaurar depois
    } catch (err) {
        console.error(err);
      ...
      <div className="perfil-content">
        <div className="perfil-form">
          ...
          <div className="coluna">
            ...
            {cargos.map((cargo) => (
                <option key={cargo.id} value={cargo.id}>{cargo.nome}</option> // valor = _id
            ))}
            </select>
            ...
            {setores.map((setor) => (
                <option key={setor.id} value={setor.id}>{setor.nome}</option> // valor = _id
            ))}
            </select>
